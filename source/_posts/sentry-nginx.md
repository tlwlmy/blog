...
server {
    ...
    access_log  /home/ymserver/log/nginx/log.sentry.com.access.log ;
    #access_log off;
    error_log  /home/ymserver/log/nginx/log.sentry.com.error.log;
    ...
    #auth_basic_user_file /home/ymserver/auth/sentry-user;
